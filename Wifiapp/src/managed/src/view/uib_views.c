...
#define DEF_STARTUP_VIEW_NAME "mainView"
...
static void (*uib_mainView_config_delegate_portrait)();
static void (*uib_mainView_config_delegate_landscape)();

char* g_mainView_config_name_portrait = NULL;
char* g_mainView_config_name_landscape = NULL;
...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_CIRCLE_360x360:
			uib_mainView_config_delegate_portrait = &uib_mainView_config_CIRCLE_360x360_portrait;
			g_mainView_config_name_portrait = "common";
			uib_mainView_config_delegate_landscape = &uib_mainView_config_CIRCLE_360x360_portrait;
			g_mainView_config_name_landscape = "common";
...
void set_targeted_view(uib_view_context* vc) {
	...
	if(gi_cur_user_view_idx < 0) {
		if(!strcmp(view_name,"mainView")) {
			gst_uib_views.uib_view_target_config_portrait = uib_mainView_config_delegate_portrait;
			gst_uib_views.uib_view_target_config_landscape = uib_mainView_config_delegate_landscape;

			g_views_config_delegate_name_portrait = g_mainView_config_name_portrait;
			g_views_config_delegate_name_landscape = g_mainView_config_name_landscape;
